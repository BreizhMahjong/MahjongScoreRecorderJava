	...
	public UITabPanelRCRGameHistory(final DataAccessRCR dataAccess) {
...

		{
...

			{
				...
				final JLabel labelTitleRounds = new JLabel("Manche : ", SwingConstants.RIGHT);
				labelTitleRounds.setPreferredSize(labelSizes[3]);
				centerPanel.add(labelTitleRounds, constraints);

				constraints.gridx = 4;
				labelRounds = new JLabel("", SwingConstants.LEFT);
				labelRounds.setPreferredSize(labelSizes[4]);
				centerPanel.add(labelRounds, constraints);
			}

			{
				...
				constraints.gridx = 2;
				final JLabel labelTitleGameScore = new JLabel("Stack", SwingConstants.CENTER);
				...
				constraints.gridx = 3;
				final JLabel labelTitleUma = new JLabel("UMA", SwingConstants.CENTER);
				labelTitleUma.setBorder(BorderFactory.createLineBorder(Color.BLACK));
				labelTitleUma.setPreferredSize(labelSizes[3]);
				centerPanel.add(labelTitleUma, constraints);

				constraints.gridx = 4;
				final JLabel labelTitleScore = new JLabel("Score", SwingConstants.CENTER);
