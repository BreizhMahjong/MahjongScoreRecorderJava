...
public class MCRDataPackageTrend {
	...
	public MCRDataPackageTrend(final List<Long> dates, final List<String> playerNames, final List<String> displayNames, final List<List<Integer>> data) {
		this.dates = dates;
