	...
	public UITabPanelRCRGameHistory(final DataAccessRCR dataAccess, final JDialogWithProgress waitingDialog) {
...

		{
...

			{
				...
				final JLabel labelTitleRounds = new JLabel("Manche : ", JLabel.RIGHT);
				labelTitleRounds.setPreferredSize(labelSizes[3]);
				centerPanel.add(labelTitleRounds, constraints);

				constraints.gridx = 4;
				labelRounds = new JLabel("", JLabel.LEFT);
...

			{
				...
				constraints.gridx = 2;
				final JLabel labelTitleGameScore = new JLabel("Stack", JLabel.CENTER);
				...
				constraints.gridx = 3;
				final JLabel labelTitleUma = new JLabel("UMA", JLabel.CENTER);
				...
				constraints.gridx = 4;
				final JLabel labelTitleScore = new JLabel("Score", JLabel.CENTER);
